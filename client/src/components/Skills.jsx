...
import { SiRails, SiHtml5, SiCss3, SiJavascript, SiPostgresql, SiRedux, } from "react-icons/si";
import './Skills.css'
        ...
        <div className='lg:mx-28 font-serif '>
            <div className='lg:bg-gray-200 lg:py-12 lg:my-14 lg:rounded-3xl '>
                ...
                <div className='skills lg:text-xl lg:font-bold lg:italic lg:py-3 lg:flex lg:justify-evenly lg:py-10'>
                    ...
                    <div >
                        <SiCss3 className='icon' size={40} />
                        <p className='text'>CSS</p>
                    </div>
                    <div >
                        <SiHtml5 className='icon' size={40} />
                    ...
                    <div >
                        <SiRedux className='icon' size={40} />
                        <p className='text'>Redux</p>
                    </div>
                    <div>
                        <DiRuby className='icon' size={40} />
                        <p className='text'>Ruby</p>
                    </div>

                    <div >
                        <SiRails className='icon' size={40} />
                        <p className='text'>Ruby on Rails</p>
                    </div>

                    <div >
                        <DiMongodb className='icon' size={40} />
                        <p className='text'>MongoDB</p>
                    </div>
                    <div >
                        <SiPostgresql className='icon' size={40} />
