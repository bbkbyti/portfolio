            ...
            <div className=' min-h-screen flex flex-col'>
                <div className='lg:grid lg:grid-cols-2 lg:mt-10' >
                    ...
                    <div className='lg:rounded-3xl lg:bg-gray-200 lg:py-2 lg:px-6 lg:mr-28 mx-10 py-4 text-lg font-bold '>
                        <p className='lg:pt-36 lg:font-bold lg:italic lg:leading-9 '>
                            I am a motivated, adaptable and responsible Software Developer proficient at utilizing efficient frameworks that minimize defects and increase productivity.
