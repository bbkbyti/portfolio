    ...
    return (
        <div className=' lg:min-h-screen lg:font-serif '>
            <div className=' min-h-screen flex flex-col'>
                <div className='lg:grid lg:grid-cols-2 lg:my-10' >
                <Info />
                <div className='lg:rounded-3xl lg:bg-gray-200 lg:py-2 lg:px-6 lg:mr-28'>
                <h1 className='lg:pt-36 lg:font-bold lg:italic lg:leading-9 '>Supportive and communicative Junior Developer with a background in customer service and management.
