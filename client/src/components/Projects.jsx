...
export default function Projects() {
    return (
        <div>
            <div className='lg:flex lg:flex-col lg:items-center lg:bg-gray-200 lg:mx-28 lg:rounded-3xl lg:mb-8'>
                <h2 className='lg:text-4xl lg:italic lg:font-bold lg:pt-12'>
                    Projects</h2>
                <div className='lg:grid lg:grid-cols-2 lg:py-8 lg:px-16'>
                    <div className='lg:mr-10 lg:mt-10 lg:rounded lg:overflow-hidden lg:shadow-lg lg:bg-gray-400 lg:relative  lg:transition lg:duration-500 hover:opacity-70 transform ease-in-out hover:-translate-y-1 hover:scale-110 '>
                        <p className='lg:text-xl lg:py-1 lg:italic lg:font-bold'
                        >Blue Sky</p>
